...
const AboutDetail = () => {
    ...
    return (
        <>
            <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center" data-testid="modal-overlay">
                <div className="bg-white rounded-lg p-8 w-1/2" data-testid="about-modal">
                    <Image src={`https://picsum.photos/400/400?random=${Date.now()}`} alt="dynamic image" className="w-40 h-40 rounded-full mb-4" width={400} height={400} data-testid="about-image" />
                    <h1 className="text-4xl font-bold mb-4" data-testid="about-title">About Me</h1>
